...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    {
        punteroNodo = this->pFirstNode;

        for(i=0; i<nodeIndex; i++)
        {
            punteroNodo = punteroNodo->pNextNode;
        }
...
void* ll_get(LinkedList* this, int index)
{
    ...
    {
        nodeBuscado = getNode(this, index);
        returnAux = nodeBuscado->pElement;
    }
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    {
        nodeModificado = getNode(this, index);
        nodeModificado->pElement = pElement;
...
int ll_remove(LinkedList* this,int index)
{
    ...
    {
        nodeEliminado = getNode(this, index);

        if(nodeEliminado == NULL)
        {
            returnAux = -1;
        }
        else
        {
            if(index == 0)
            {
                this->pFirstNode = nodeEliminado->pNextNode;
                this->size--;
            }
            else
            {
...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
        for(i=0; i<tam; i++)
        {
            nodeBuscado = getNode(this, i);
            if(nodeBuscado->pElement == pElement)
            {
                returnAux = i;
                break;
            }
...
void* ll_pop(LinkedList* this,int index)
{
    ...
    {
        nodeBuscado = ll_get(this, index);
        ll_remove(this, index);

        returnAux = nodeBuscado;
    }
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        else
        {
            for(i=0; i<tam; i++)
            {
                ...
                validacion = ll_contains(this, pElement);
